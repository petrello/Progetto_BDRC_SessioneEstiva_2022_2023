    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    return RedirectToAction(nameof(LoginTwoStep), new { model.Username, model.RememberLogin, model.ReturnUrl});
                }
        ...
        [HttpGet]
        public async Task<IActionResult> LoginTwoStep(string username, bool rememberMe, string returnUrl = null)
        {
